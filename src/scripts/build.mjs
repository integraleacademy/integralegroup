...
function shell(page, body, buttons) {
  ...
  const pageStyles = page.route === '/'
    ...
    : ['/integrale-connect-plus', '/integrale-connect-crm'].includes(page.route)
      ? '<link rel="stylesheet" href="/assets/tools.css"><link rel="stylesheet" href="/assets/product-sales.css">' + (page.route === '/integrale-connect-crm' ? '<link rel="stylesheet" href="/assets/crm-feature-highlights.css">' : '')
...
fs.copyFileSync('public/crm-feature-highlights.css', `${out}/assets/crm-feature-highlights.css`);
