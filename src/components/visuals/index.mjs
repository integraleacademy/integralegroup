...
export const HeroVisualGroup=()=>panel('heroVisualGroup',`<div class="groupCore"><b>IG</b><span>strategy hub</span><small>certification · digital · SaaS</small></div><div class="growthPath"></div><div class="orbitNodes">${['Certification','Web','SaaS','Connect','Data','Scale'].map(x=>`<em>${x}</em>`).join('')}</div><div class="barStack"><span></span><span></span><span></span></div><div class="microDashboard">${metric('Vision','Groupe')}${metric('Actifs','4 pôles')}${metric('Outils','Métier')}</div>${rails(3)}${dots(24)}`,'Structuration, croissance et interconnexion');
